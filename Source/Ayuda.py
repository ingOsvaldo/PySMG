...
class Ayuda:
    def __init__(self):
        ...
        window.set_title ("Acerca de PyGMS")
        ...
        frameB = gtk.Frame("Créditos de PyGMS")
        frameB.set_border_width(10)
        frameB.set_size_request(510, 400)
                
        # SE AGREGA LA PAGINA AL CUADERNO
        label = gtk.Label("Créditos de PyGMS")
        ...
        frameC = gtk.Frame("Licencia de PyGMS")
        frameC.set_border_width(10)
        frameC.set_size_request(510, 400)
                
        # SE AGREGA LA PAGINA AL CUADERNO
        label = gtk.Label("Licencia de PyGMS")
        notebook.append_page(frameC,label)
        
        texto = '''PyGMS es software libre: puede redistribuirlo y/o modificarlo bajo los
